    ...
    sidebar: [
      {
        ...
        items: [
          { text: 'Überblick', link: '/gemeinschaft/' },
          { text: 'Selbstverständnis', link: '/gemeinschaft/selbstverstaendnis' },
          { text: 'Aufnahmebedingungen', link: '/gemeinschaft/aufnahmebedingungen' }
        ]
      },
      {
        text: 'Regeln',
        items: [
          { text: 'Überblick', link: '/regeln/' },
          { text: 'Grundregeln', link: '/regeln/grundregeln' },
          { text: 'WhatsApp', link: '/regeln/whatsapp' },
          { text: 'Zusammenkünfte', link: '/regeln/zusammenkuenfte' }
        ]
      },
      {
        text: 'Fleischmeldeamt',
        items: [
          { text: 'Überblick', link: '/fleischmeldeamt/' },
          { text: 'Monatliche Abfrage', link: '/fleischmeldeamt/monatliche-abfrage' },
          { text: 'Fleischversammlungen', link: '/fleischmeldeamt/fleischversammlungen' },
          { text: 'Hauptfleischversammlung', link: '/fleischmeldeamt/hauptfleischversammlung' },
          { text: 'Fragab', link: '/fleischmeldeamt/fragab' }
        ]
      },
      {
        text: 'Organisation',
